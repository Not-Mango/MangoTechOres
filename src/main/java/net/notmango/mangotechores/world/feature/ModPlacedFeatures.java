...
public class ModPlacedFeatures {
    ...
    public static final PlacedFeature APATITE_ORE_PLACED = PlacementUtils.register("apatite_ore_placed",
            ModConfiguredFeature.APATITE_ORE.placed(ModOrePlacement.commonOrePlacement(5,
    ...
    public static final PlacedFeature AQUAMARINE_ORE_PLACED = PlacementUtils.register("aquamarine_ore_placed",
            ModConfiguredFeature.AQUAMARINE_ORE.placed(ModOrePlacement.commonOrePlacement(5,
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-30), VerticalAnchor.aboveBottom(180)))));
    ...
    public static final PlacedFeature TIN_ORE_PLACED = PlacementUtils.register("topaz_ore_placed",
            ModConfiguredFeature.TIN_ORE.placed(ModOrePlacement.commonOrePlacement(5,
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-30), VerticalAnchor.aboveBottom(240)))));
}
