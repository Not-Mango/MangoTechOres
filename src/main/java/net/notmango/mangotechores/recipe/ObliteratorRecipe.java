...
public class ObliteratorRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public ObliteratorRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<ObliteratorRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(MangoTechOres.MOD_ID,"obliterating");
        ...
        public ObliteratorRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ObliteratorRecipe(id, output, inputs);
        }

        @Override
        public ObliteratorRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, ObliteratorRecipe recipe) {
